...
class KantMenuItem : public QCustomMenuItem
{
public:
    KantMenuItem( const QString& s, const QFont& f,const QPixmap &p )
        : string( s ), font( f ), pixmap(p){qDebug((" KantMenuItem-Constructor:"+s).latin1());};
