...
#include "./part/kantpartview.h"
#include "./part/kantpartdocument.h"
...
class TopLevel : public KParts::MainWindow
{
  ...
  public:
    TopLevel(KantPartDocument * = 0L, const QString &path = QString::null);
    ~TopLevel();
  ...
  protected:
    ...
    void setupEditWidget(KantPartDocument *);
    void setupActions();
    void setupStatusBar();
