  ...
  , m_replace( 0L )
{
  ...
  m_opt1->setChecked( flags & KantView::sfCaseSensitive );
  m_opt2->setChecked( flags & KantView::sfWholeWords );
  m_opt3->setChecked( flags & KantView::sfFromCursor );
  m_optRegExp->setChecked( flags & KantView::sfRegularExpression );
  m_opt4->setChecked( flags & KantView::sfBackward );
  m_opt5->setChecked( flags & KantView::sfSelected );

  if( m_replace )
  {
    m_opt6 = new QCheckBox( i18n( "&Prompt On Replace" ), group );
    m_opt6->setChecked( flags & KantView::sfPrompt );
...
int SearchDialog::getFlags()
{
  ...
  if( m_opt1->isChecked() ) flags |= KantView::sfCaseSensitive;
  if( m_opt2->isChecked() ) flags |= KantView::sfWholeWords;
  if( m_opt3->isChecked() ) flags |= KantView::sfFromCursor;
  if( m_opt4->isChecked() ) flags |= KantView::sfBackward;
  if( m_opt5->isChecked() ) flags |= KantView::sfSelected;
  if( m_optRegExp->isChecked() ) flags |= KantView::sfRegularExpression;
  if( m_replace )
  {
    if( m_opt6->isChecked() )
      flags |= KantView::sfPrompt;

    flags |= KantView::sfReplace;
  }
...
const int IndentConfigTab::flags[] = {KantView::cfAutoIndent, KantView::cfSpaceIndent,
  KantView::cfBackspaceIndents,KantView::cfTabIndents, KantView::cfKeepIndentProfile, KantView::cfKeepExtraSpaces};

IndentConfigTab::IndentConfigTab(QWidget *parent, KantView *kWrite)
  : QWidget(parent, 0L)
{
  ...
  // What is this? help
  QWhatsThis::add(opt[0], i18n("When <b>Auto indent</b> is on, KantView will indent new lines to equal the indent on the previous line.<p>If the previous line is blank, the nearest line above with text is used"));
...
void IndentConfigTab::getData(KantView *kWrite) {
  int configFlags, z;
...
const int SelectConfigTab::flags[] = {KantView::cfPersistent, KantView::cfDelOnInput,
  KantView::cfMouseAutoCopy, KantView::cfSingleSelection, KantView::cfVerticalSelect, KantView::cfXorSelect};

SelectConfigTab::SelectConfigTab(QWidget *parent, KantView *kWrite)
  : QWidget(parent, 0L)
{
  QVBoxLayout *layout = new QVBoxLayout(this, 0, KDialog::spacingHint() );
  int configFlags = kWrite->config();
...
void SelectConfigTab::getData(KantView *kWrite) {
  int configFlags, z;
...
const int EditConfigTab::flags[] = {KantView::cfWordWrap, KantView::cfReplaceTabs, KantView::cfRemoveSpaces,
  KantView::cfAutoBrackets, KantView::cfGroupUndo, KantView::cfShowTabs, KantView::cfSmartHome,
  KantView::cfPageUDMovesCursor, KantView::cfWrapCursor};

EditConfigTab::EditConfigTab(QWidget *parent, KantView *kWrite)
  : QWidget(parent, 0L) {
  ...
  // What is this? help
  QWhatsThis::add(opt[0], i18n("Word wrap is a feature that causes the editor to automatically start a new line of text and move (wrap) the cursor to the beginning of that new line. KantView will automatically start a new line of text when the current line reaches the length specified by the Wrap Words At: option.<p><b>NOTE:<b> Word Wrap will not change existing lines or wrap them for easy reading as in some applications."));
  ...
  QWhatsThis::add(opt[1], i18n("KantView will replace any tabs with the number of spaces indicated in the Tab Width: entry."));
  ...
  QWhatsThis::add(opt[2], i18n("KantView will automatically eliminate extra spaces at the ends of lines of text."));
  QWhatsThis::add(opt[3], i18n("When the user types a left bracket ([,(, or {) KantView automatically enters the right bracket (}, ), or ]) to the right of the cursor."));
...
void EditConfigTab::getData(KantView *kWrite)
{
  int configFlags, z;
