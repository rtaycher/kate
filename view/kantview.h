...
class KantViewInternal : public QWidget {
    Q_OBJECT
...
//  virtual void dragLeaveEvent( QDragLeaveEvent * );
  ...
  signals:
    // emitted when KantViewInternal is not handling its own URI drops
...
/**
  The KantView text editor widget. It has many options, document/view
...
class KantView : public KTextEditor::View, virtual public KantViewIface {
  ...
  public:
    /**
      The document can be used by more than one KantView objects.
...
//edit functions
  ...
  public slots:
    ...
    */
    void indent() {doEditCommand(KantView::cmIndent);};
    /**
      Moves the current line or the selection one position to the left
    */
    void unIndent() {doEditCommand(KantView::cmUnindent);};
    /**
      Optimizes the selected indentation, replacing tabs and spaces as needed
    */
    void cleanIndent() {doEditCommand(KantView::cmCleanIndent);};
    /**
      Selects all text
    */
    void selectAll() {doEditCommand(KantView::cmSelectAll);}
    /**
      Deselects all text
    */
    void deselectAll() {doEditCommand(KantView::cmDeselectAll);}
    /**
      Inverts the current selection
    */
    void invertSelection() {doEditCommand(KantView::cmInvertSelection);}
    /**
      comments out current line
    */
    void comment() {doEditCommand(KantView::cmComment);};
    /**
      removes comment signs in the current line
    */
    void uncomment() {doEditCommand(KantView::cmUncomment);};

    void keyReturn() {doEditCommand(KantView::cmReturn);};
    void keyDelete() {doEditCommand(KantView::cmDelete);};
    void backspace() {doEditCommand(KantView::cmBackspace);};
    void killLine() {doEditCommand(KantView::cmKillLine);};

// cursor commands...

    void cursorLeft() {doCursorCommand(KantView::cmLeft);};
    void shiftCursorLeft() {doCursorCommand(KantView::cmLeft | selectFlag);};
    void cursorRight() {doCursorCommand(KantView::cmRight);}
    void shiftCursorRight() {doCursorCommand(KantView::cmRight | selectFlag);}
    void wordLeft() {doCursorCommand(KantView::cmWordLeft);};
    void shiftWordLeft() {doCursorCommand(KantView::cmWordLeft | selectFlag);};
    void wordRight() {doCursorCommand(KantView::cmWordRight);};
    void shiftWordRight() {doCursorCommand(KantView::cmWordRight | selectFlag);};
    void home() {doCursorCommand(KantView::cmHome);};
    void shiftHome() {doCursorCommand(KantView::cmHome | selectFlag);};
    void end() {doCursorCommand(KantView::cmEnd);};
    void shiftEnd() {doCursorCommand(KantView::cmEnd | selectFlag);};
    void up() {doCursorCommand(KantView::cmUp);};
    void shiftUp() {doCursorCommand(KantView::cmUp | selectFlag);};
    void down() {doCursorCommand(KantView::cmDown);};
    void shiftDown() {doCursorCommand(KantView::cmDown | selectFlag);};
    void scrollUp() {doCursorCommand(KantView::cmScrollUp);};
    void scrollDown() {doCursorCommand(KantView::cmScrollDown);};
    void topOfView() {doCursorCommand(KantView::cmTopOfView);};
    void bottomOfView() {doCursorCommand(KantView::cmBottomOfView);};
    void pageUp() {doCursorCommand(KantView::cmPageUp);};
    void shiftPageUp() {doCursorCommand(KantView::cmPageUp | selectFlag);};
    void pageDown() {doCursorCommand(KantView::cmPageDown);};
    void shiftPageDown() {doCursorCommand(KantView::cmPageDown | selectFlag);};
    void top() {doCursorCommand(KantView::cmTop);};
    void shiftTop() {doCursorCommand(KantView::cmTop | selectFlag);};
    void bottom() {doCursorCommand(KantView::cmBottom);};
    void shiftBottom() {doCursorCommand(KantView::cmBottom | selectFlag);};
